...
export default function MatchingDropdown({ subSection, answers, onAnswer }: QuestionComponentProps) {
    ...
    let opts = { ...subSection.options };
    let isAutoGenerated = false;
    const stem = subSection.question_text ?? subSection.question_stem ?? '';

    // For matching paragraphs, options are often not in JSON because they are just the paragraph letters (A-G etc.)
    ...
    return (
        <div>
            ...
            {/* Options chip grid */}
            {!isAutoGenerated && Object.keys(opts).length > 0 && (
